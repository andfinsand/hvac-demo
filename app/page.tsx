  ...
  return (
    <>
      ...
      <main className="flex flex-col text-black">
        ...
        {/* Hero container */}
        <div className="flex flex-col sm:flex-row justify-center gap-20 h-full lg:h-[80vh] min-h-[810px] sm:min-h-[750px] pt-24 xs:pt-0 lg:pt-12 px-4">

          {/* Left Column */}
          <div className="flex flex-col self-center sm:mt-16 lg:mt-0 mb-56 xs:mb-44 sm:mb-0">
            {/* Content */}
            <div className="flex flex-col items-center sm:px-8 lg:px-5">
              <h1 className="text-center sm:text-start text-[35px] sm:text-[44px] lg:text-[50px] font-black leading-tight tracking-tight w-full max-w-[470px] sm:max-w-[550px] sm:min-w-[480px] lg:w-[540px] mb-10">Your Trusted Bay Area <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-500">HVAC</span> Experts</h1>
              {/* Mobile hero image */}
              {/* <Image
                src="/hero-image.webp"
              ...
              /> */}
              <p className="self-center sm:self-start text-center sm:text-start text-md sm:text-lg font-medium leading-snug w-[370px] sm:w-[400px] md:w-[470px] max-w-[470px] lg:max-w-[540px] mb-12">Affordable, high-performance HVAC solutions for your home or business with expert heating, cooling, ducting, and refrigeration services.</p>
            </div>
            {/* Buttons */}
            <div className="flex flex-col xs:flex-row self-center sm:self-start gap-3 xs:gap-7 mr-0 px-8 lg:px-4">
              <SecondaryButton href={"/about"} label={"WHO WE ARE"} />
              <Link href="/contact">
          ...
          <div className="hidden sm:block w-80 sm:w-[420px] h-80 sm:h-[420px]"></div>
        </div>
